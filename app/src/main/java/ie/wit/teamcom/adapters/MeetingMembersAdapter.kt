...
interface MeetingMembersListener {

}

class MeetingMembersAdapter constructor(var members: ArrayList<Member>,
                                 private val listener: MeetingMembersListener): RecyclerView.Adapter<MeetingMembersAdapter.MainHolder>(){
    ...
    class MainHolder constructor(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(member: Member, listener: MeetingMembersListener) {
            itemView.tag = member
