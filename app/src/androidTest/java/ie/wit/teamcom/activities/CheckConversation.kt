...
class CheckConversation {
    ...
    fun checkConversation() {
        ...
        appCompatEditText4.perform(replaceText("hi there!"), closeSoftKeyboard())
        ...
        val textView = onView(
            allOf(
                withId(R.id.msgAuthor), withText("Test User"),
        ...
        val textView2 = onView(
            allOf(
                withId(R.id.msgContent), withText("hi there!"),
                withParent(withParent(IsInstanceOf.instanceOf(android.widget.FrameLayout::class.java))),
                isDisplayed()
            )
        )
        textView2.check(matches(withText("hi there!")))
        ...
        val viewGroup2 = onView(
            allOf(
                withParent(withParent(withId(R.id.notificationsRecyclerView))),
                isDisplayed()
            )
        )
        ...
        val textView3 = onView(
            allOf(
                withId(R.id.txtNotifType), withText("Conversation"),
                withParent(withParent(IsInstanceOf.instanceOf(android.widget.FrameLayout::class.java))),
                isDisplayed()
            )
        )
        textView3.check(matches(withText("Conversation")))

        onView(isRoot()).perform(waitFor(3000));
        val textView4 = onView(
            allOf(
                withId(R.id.txtNotifContent), withText("New Message From Test Usertwo: Hi!"),
                withParent(withParent(IsInstanceOf.instanceOf(android.widget.FrameLayout::class.java))),
                isDisplayed()
            )
        )
        textView4.check(matches(withText("New Message From Test Usertwo: Hi!")))
    }
